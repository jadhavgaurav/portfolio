...
export function Objectives({
  ...
  return (
    <div
      ...
      style={{ background: "rgba(5,7,8,0.97)" }}
    >
      <div className="mx-auto max-w-[38rem]">
        ...
        <div className="mt-8 flex items-baseline gap-4">
          <span
            ...
            style={{ color: progress.complete ? "#8cbcae" : "#e2e8f0" }}
          >
            {pct}%
          </span>
          <span className="u-mono text-[0.72rem]" style={{ color: "#8b979c" }}>
        ...
        <div className="mt-4 h-[3px] w-full" style={{ background: "#232a2e" }}>
          <div
            ...
            style={{
              width: `${pct}%`,
              background: progress.complete ? "#8cbcae" : "#5d6b73",
            }}
          />
        </div>
            ...
            <div key={c.key}>
              <div className="flex items-center justify-between gap-4">
                <span
                  ...
                  style={{ color: c.complete ? "#8cbcae" : "#cfd6d3" }}
                >
                  {c.complete && (
              ...
              <div className="mt-2 h-px w-full" style={{ background: "#232a2e" }}>
                <div
                  ...
                  style={{
                    ...
                    background: c.complete ? "#8cbcae" : "#5d6b73",
                  }}
                />
              </div>
            </div>
        ...
        {progress.complete ? (
          <p className="mt-10 text-[0.9rem] leading-[1.6]" style={{ color: "#8cbcae" }}>
            Everything here has been found. There is no further reward for
            that — the record was always the whole point.
          </p>
        ) : (
          <p className="mt-10 text-[0.9rem] leading-[1.6]" style={{ color: "#69757a" }}>
